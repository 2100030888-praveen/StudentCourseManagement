...
/*DEMO Button*/
a.demobutton {
    background: #76757b none repeat scroll 0 0;
    color: #fff;
...
a.demobutton {
  background: #9e9da3 none repeat scroll 0 0;
  color: #fff;
  display: table;
  font-size: 14px;
  font-weight: 600;
...
.authfy-panel-left {
  background-color: rgba(146, 147, 154, 0.92);
  color: #ffffff;
  border-top-left-radius: 4px;
  border-bottom-left-radius: 4px;
  -webkit-box-shadow: 0px 3px 6px #818289;
  box-shadow: 0px 3px 6px #9fa0a5;
}
...
/* Hide password input text when it's not focused */
.password::-ms-reveal,
.password::-ms-clear {
    display: none;
}

/* Hide password input text when it's focused */
.password::-webkit-credentials-auto-fill-button,
.password::-webkit-credentials-auto-fill-button:focus-visible,
.password::-webkit-credentials-auto-fill-button:focus {
    display: none;
}
</style>
</head>
...
<!-- <a class="demobutton" href="https://codeconvey.com/login-page-in-html-with-css-code">Back To Tutorial</a>	 -->
          ...
          <div class="headline">
            ...
            <div class="brand-logo">
                <!-- <img src="https://1.bp.blogspot.com/-3he0CGCSWHA/XyqopZcixRI/AAAAAAAAVM8/Mdfk_mPQa0Ydb7IAH0Iir8F4Ge7xxF0ygCLcBGAsYHQ/s0/logo.png" width="150" alt="brand-logo"> -->
                 <img src="./images/logo3.png" width="100" alt="brand-logo"> 
            </div><!-- ./brand-logo -->
            ...
            <div class="row social-buttons">
              <div class="col-xs-4 col-sm-4 col-md-12">
                <a href="#" class="btn btn-block btn-facebook">
                  <span class="hidden-xs hidden-sm"> <i class="fab fa-facebook"></i>Signin with facebook</span>
                </a>
              </div>
              <div class="col-xs-4 col-sm-4 col-md-12">
                <a href="#" class="btn btn-block btn-twitter">
                  <span class="hidden-xs hidden-sm"><i class="fa fa-twitter"></i> Signin with twitter</span>
                </a>
              </div>
              <div class="col-xs-4 col-sm-4 col-md-12">
                <a href="#" class="btn btn-block btn-google">
                  <i class="fa fa-google-plus"></i> <span class="hidden-xs hidden-sm"><i class="fab fa-google"></i>Signin with google</span>
                </a>
              </div>
            </div><!-- ./social-buttons -->
          </div>
          ...
          <div class="authfy-panel panel-login text-center active">
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12">
                <form name="loginForm" class="loginForm" action="checklogin" method="POST">
                  <div class="form-group">
                    <input type="text" class="form-control email" name="username" placeholder="Username or Email" required="required">
                  </div>
                  <!-- <div class="form-group">
                    <div class="pwdMask">
                  ...
                  <div class="row remember-row">
                    ...
                    <div class="col-xs-5 col-sm-5">
                        <p class="forgotPwd">
                          <a class="lnk-toggler" data-panel=".panel-forgot" href="#"><i class="fa fa-arrow-left"></i>home</a>
                        </p>
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <input class="btn btn-lg btn-primary btn-block" type="submit" value="Login" class="button"></td>
