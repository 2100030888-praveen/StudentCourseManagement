    ...
    <thead>
      <tr>
        <th>Course ID</th>
            ...
            <th>Year</th>
            <th>Semester</th>
            <th>Limit Number Enrollments</th>
    ...
    <tbody>
      ...
      <c:forEach items="${coursesList}" var="course">
            <tr>
                ...
                <td>${course.course_departement_id}</td>
                <td>${course.course_cc_id}</td>
                <td>${course.course_year}</td>
                <td>${course.course_sem}</td>
                <td>${course.limit_number_enrollments}</td>
                <td>${course.course_description}</td>
                <td>
                  <a href="javascript:void(0);" onclick="confirmEdit(${course.course_id}, '${course.course_departement_id}');">Edit</a>
					|
					<a href="javascript:void(0);" onclick="confirmDelete(${course.course_id});">Delete</a>
				</td>
            </tr>
        </c:forEach>
    </tbody>
...
<script>
function confirmEdit(courseId, departmentId) {
    var confirmation = confirm("Are you sure you want to edit this course?");
    
    if (confirmation) {
        window.location.href = "editCourse?cid=" + courseId + "&did=" + departmentId;
    }
}
